...
export default function LogoPremium({ width = "120px", className = "", white = false }) {
    return (
        <div className={`logo-container-shine ${className}`} style={{ width, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px', padding: '8px 0' }}>
            <img
                src={logoSurgilinkGreen}
                alt="SurgiLink Bolt"
                style={{ width: '54px', height: 'auto', marginBottom: '-2px', filter: white ? 'brightness(0) invert(1)' : 'none' }}
            />
            <svg
                width="100%"
                height="auto"
                viewBox="0 640 727 100"
                fill="none"
            ...
            >
                <defs>
                    <linearGradient id="premiumAccentGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" style={{ stopColor: white ? '#FFFFFF' : '#6D8C7C', stopOpacity: 1 }} />
                        <stop offset="50%" style={{ stopColor: white ? '#FFFFFF' : '#577364', stopOpacity: 1 }} />
                        <stop offset="100%" style={{ stopColor: white ? '#E2EBE6' : '#465E51', stopOpacity: 1 }} />
                    </linearGradient>
                </defs>
                <path
                    ...
                    fill={white ? "url(#premiumAccentGradient)" : "#6D8C7C"}
                    stroke={white ? "url(#premiumAccentGradient)" : "#6D8C7C"}
                    strokeWidth="0.5"
                />
                <path
