...
export default function LogoPremium({ width = "120px", className = "", white = false }) {
    return (
        <div className={className} style={{ width, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
            <img
                src={logoSurgilinkPurple}
                alt="SurgiLink Bolt"
                style={{ width: '50px', height: 'auto', marginBottom: '-4px', filter: white ? 'brightness(0) invert(1)' : 'none' }}
            />
            <svg
                width="100%"
                height="auto"
            ...
            >
                ...
                <path
                    ...
                    fill="url(#premiumAccentGradient)"
                    stroke="url(#premiumAccentGradient)"
                    strokeWidth="0.5"
                />
                <path
