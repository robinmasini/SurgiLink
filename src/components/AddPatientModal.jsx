  ...
  "room_number": "Numéro de chambre / lit (ex: 122)"
    ...
    const applyExtractedData = (data) => {
        setFormData({
            ...
            surgeonName: data.surgeon_name ? (data.surgeon_name.includes('DESOUCHES') ? 'Dr DESOUCHES' : data.surgeon_name) : 'Dr DESOUCHES',
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // 1. Generate Token Immediately if not present
